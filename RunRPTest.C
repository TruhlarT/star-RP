...
//
//  rm run.log
//  root4star -l -b -q RunRPTest.C |& cat > run.log &


//_____________________________________________________________________________
void RunRPTest(string filelist="txt/sim_slight14e3.list",
               Int_t nFiles=999999,
               string outfile="../star-upc-data/trees/starsim/StUPC_slight14e3.root") {
  ...
  gSystem->Load("StUPCFilterMaker.so");  // čím nahradit???
